...
A free e-signature tool in a **single HTML file**, with the source published so you can check it. No account, no install, no upload to anyone's server; your document never leaves your browser unless you choose to email it.
...
The **Send for signature** button uses Gohvio's hosted email service: it emails your signer a secure signing link, auto-forwards the document from signer to signer, and delivers the final signed PDF to everyone automatically. That service runs on Gohvio's servers and requires an access key; it is not part of the published code.

**[Get a key, $1/month](https://buy.stripe.com/bJe8wP2rD12GdkY0CY38405)** or **[$10/year](https://buy.stripe.com/7sY5kD2rDh1EbcQ1H238409)** (save 17%). Recurring subscription, cancel anytime. Your key arrives by email within a minute; paste it into the tool once and you're set. Questions? Contact [emilygoh@gohvio.io](mailto:emilygoh@gohvio.io).
...
- Signing links from the hosted service are HMAC-signed and expire after 14 days.
...
**Source-available, not open source.** The code in this repo is published so you can verify the
security claims above for yourself, not so it can be resold or relaunched as a competing product.

Licensed under the [PolyForm Shield License 1.0.0](LICENSE). In short:

- ✅ Read it, run it, modify it, use it inside your own business, for any purpose
- ✅ Receive, open and sign a signing file generated by Snail Sign, no licence needed
- ❌ Use it, in whole or in part, to provide a product or service that competes with Snail Sign, paid or free
- ❌ Use the Snail Sign or Gohvio names or logos

The hosted send-for-signature service, the access key system and the servers behind them are not
published and are not covered by this licence.

Versions published before 11 August 2026 were released under the MIT licence; that grant still
applies to those versions.

## Legal

- [Privacy Notice](https://snailsign.com/privacy.html)
- [Terms of Use](https://snailsign.com/terms.html)

© 2026 Gohvio, Inc. Snail Sign is a Gohvio product.
